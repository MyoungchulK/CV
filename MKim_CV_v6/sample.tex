...
\begin{itemize}
\item Deployed {\bf AI models} on {\bf large-scale infrastructure networks} to predict {\bf Likelihood of Failure (LOF)} and deliver risk assessments to clients.
\item Engineered {\bf end-to-end ML pipeline automation}, improving efficiency and reducing manual intervention.
\item Developed an {\bf LLM-powered multi-agent system} leveraging {\bf LangGraph} and {\bf RAG} for automated {\bf raw data cleaning} prior to ML ingestion.
\end{itemize}
\divider
